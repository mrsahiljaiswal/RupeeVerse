    ...
    <footer className="bg-background pt-16 pb-6">
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          <div>
            <div className="text-primary font-poppins font-bold text-xl mb-4">RupeeVerse</div>
            <p className="text-muted-foreground mb-4">
              Banking innovation for rural communities with offline-first technology and blockchain security.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/finlearn" className="text-muted-foreground hover:text-primary transition-colors">
                  FinLearn Education
                </Link>
              </li>
              <li>
                <Link to="/rupee-ai" className="text-muted-foreground hover:text-primary transition-colors">
                  Rupee AI Assistant
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-6 mt-10 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground mb-4 md:mb-0">
              © {new Date().getFullYear()} RupeeVerse. All rights reserved.
            </p>
